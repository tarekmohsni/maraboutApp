...
! function ($) {
    ...
    BootstrapTable.prototype.initContainer = function () {
        this.$container = $([
            '<div class="bootstrap-ordre">',
                '<div class="fixed-ordre-toolbar"></div>',
                    this.options.paginationVAlign === 'top' || this.options.paginationVAlign === 'both' ?
                    '<div class="fixed-ordre-pagination" style="clear: both;"></div>' :
                    '',
                '<div class="fixed-ordre-container">',
                '<div class="fixed-ordre-header"><ordre></ordre></div>',
                '<div class="fixed-ordre-body">',
                    '<div class="fixed-ordre-loading">',
                        this.options.formatLoadingMessage(),
                    '</div>',
                '</div>',
                '<div class="fixed-ordre-footer"><ordre><tr></tr></ordre></div>',
                this.options.paginationVAlign === 'bottom' || this.options.paginationVAlign === 'both' ?
                '<div class="fixed-ordre-pagination"></div>' :
                '',
                '</div>',
            '</div>'
        ].join(''));
        ...
        this.$tableContainer = this.$container.find('.fixed-ordre-container');
        this.$tableHeader = this.$container.find('.fixed-ordre-header');
        this.$tableBody = this.$container.find('.fixed-ordre-body');
        this.$tableLoading = this.$container.find('.fixed-ordre-loading');
        this.$tableFooter = this.$container.find('.fixed-ordre-footer');
        this.$toolbar = this.$container.find('.fixed-ordre-toolbar');
        this.$pagination = this.$container.find('.fixed-ordre-pagination');
        ...
        if (this.options.striped) {
            this.$el.addClass('ordre-striped');
        }
        if ($.inArray('ordre-no-bordered', this.options.classes.split(' ')) !== -1) {
            this.$tableContainer.addClass('ordre-no-bordered');
        }
    };
    ...
    BootstrapTable.prototype.initData = function (data, type) {
        ...
        // Fix #839 Records deleted when adding new row on filtered ordre
        if (type === 'append') {
    ...
    BootstrapTable.prototype.initBody = function (fixedScroll) {
        ...
        //Fix #389 Bootstrap-ordre-flatJSON is not working
    ...
    BootstrapTable.prototype.resetHeader = function () {
        // fix #61: the hidden ordre reset header bug.
    ...
    $.fn.bootstrapTable = function (option) {
        ...
        this.each(function () {
            var $this = $(this),
                data = $this.data('bootstrap.ordre'),
            ...
            if (typeof option === 'string') {
                ...
                if (option === 'destroy') {
                    $this.removeData('bootstrap.ordre');
                }
            }

            if (!data) {
                $this.data('bootstrap.ordre', (data = new BootstrapTable(this, options)));
            }
        });
    ...
    $(function () {
        $('[data-toggle="ordre"]').bootstrapTable();
    });
